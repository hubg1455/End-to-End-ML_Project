...
import sys,os
from price_prediction.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
...
from evidently.model_profile import Profile    #create json kind of report
...
class DataValidation:
    ...
    def get_and_save_drift_report(self):
        try:
            #create profile object from evidently library
    ...
    def is_data_drift_found(self)->bool:
        try:
            ...
            report=self.get_and_save_drift_report()
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        ...
        try:
            ...
            data_validation_artifact=DataValidationArtifact(
                ...
                report_page_file_path=self.data_validation_config.report_page_file_path,
                is_validated=True,
                message="Data validation has been completed"
            )
